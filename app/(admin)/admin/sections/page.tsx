...
export default async function AdminSectionsPage() {
  ...
  return (
    <div className="space-y-10">
      <div>
        <p className="section-title">Landing Content</p>
        <h2 className="mt-3 text-3xl font-semibold text-sand-900">Homepage Content</h2>
        <p className="mt-2 text-sm text-koa">Update the hero, welcome message, schedule, and logistics for the public site.</p>
      </div>
      <ContentForm site={site} action={updateSiteSettings} />
      <div>
        <p className="section-title">Sections</p>
        <h2 className="mt-3 text-3xl font-semibold text-sand-900">Custom Content Blocks</h2>
        <p className="mt-2 text-sm text-koa">Add, remove, or reorder custom sections that appear on the homepage.</p>
      </div>
